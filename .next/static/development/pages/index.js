...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_enter_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-enter-view */ "./node_modules/react-enter-view/lib/index.js");
...
/***/ "./node_modules/react-enter-view/lib/index.js":
/*!****************************************************!*\
  !*** ./node_modules/react-enter-view/lib/index.js ***!
  \****************************************************/
/*! no static exports found */
...
var InViewListener = /** @class */ (function (_super) {
    __extends(InViewListener, _super);
    function InViewListener() {
        ...
        _this.children = React.cloneElement(_this.props.children, {
            ref: _this.childrenRef,
        });
        _this.handleScroll = function () {
            if (_this.canUpdate) {
                var inView = _this.checkInView();
                if (inView !== _this.state.inView) {
                    _this.setState({ inView: inView });
                    if (inView) {
                        _this.props.onEnterView();
                    }
                    else {
                        _this.props.onExitView();
                    }
                }
                _this.canUpdate = false;
                setTimeout(function () { return (_this.canUpdate = true); }, _this.props.throttle);
            }
        };
        _this.checkInView = function () {
            if (_this.childrenRef.current) {
                if (window.scrollY + window.innerHeight >
                    _this.childrenRef.current.offsetTop &&
                    window.scrollX + window.innerWidth >
                        _this.childrenRef.current.offsetLeft &&
                    _this.childrenRef.current.offsetTop +
                        _this.childrenRef.current.getBoundingClientRect().height >
                        window.scrollY &&
                    _this.childrenRef.current.offsetLeft +
                        _this.childrenRef.current.getBoundingClientRect().width >
                        window.scrollX) {
                    return true;
                }
            }
    ...
    InViewListener.prototype.componentDidMount = function () {
        window.addEventListener('scroll', this.handleScroll);
        // Check if child node is already in view.
        var inView = this.checkInView();
        if (inView) {
            this.props.onEnterView();
        }
    };
    InViewListener.prototype.render = function () {
        return this.children;
    };
    InViewListener.defaultProps = {
        onEnterView: function () { return null; },
        onExitView: function () { return null; },
        throttle: 100,
    };
    return InViewListener;
}(React.Component));
exports.InViewListener = InViewListener;
